let Builder,By,Key,until,chrome,getNameList,db,readline;_601‍.x([["init",()=>init],["runScript",()=>runScript]]);_601‍.w("selenium-webdriver",[["Builder",["Builder"],function(v){Builder=v}],["By",["By"],function(v){By=v}],["Key",["Key"],function(v){Key=v}],["until",["until"],function(v){until=v}]]);_601‍.w("selenium-webdriver/chrome",[["default",["chrome"],function(v){chrome=v}]]);_601‍.w("./util",[["getNameList",["getNameList"],function(v){getNameList=v}]]);_601‍.w("./db",[["default",["db"],function(v){db=v}]]);_601‍.w("readline",[["default",["readline"],function(v){readline=v}]]);
       ...
       async function init (searchOptions, callback) {
...
function sleep(ms) {
    return new Promise(resolve => setTimeout(resolve, ms));
       ...
       async function runScript(credentials, timeInterval) {
